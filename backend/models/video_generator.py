...
class VideoGenerator:
    ...
    async def load_model(self, model_name: str) -> bool:
        ...
        try:
            ...
            if model_name == "stable-video-diffusion":
                ...
                raise ValueError(f"Unknown model: {model_name}. Only 'stable-video-diffusion' is supported.")
    ...
    async def generate(self, prompt: str, model_name: str, duration: int = 5, 
        ...
        try:
            ...
            if model_name == "stable-video-diffusion":
                ...
                raise ValueError(f"Unsupported model: {model_name}. Only 'stable-video-diffusion' is supported.")
    ...
    def _create_svd_input_image(self, prompt: str) -> Image.Image:
        ...
        image = Image.new('RGB', (256, 144), color='white')
        draw = ImageDraw.Draw(image)
        
        # Add gradient background
        for y in range(144):
            color_value = int(255 * (1 - y / 144))
            draw.line([(0, y), (256, y)], fill=(color_value, color_value, 255))
